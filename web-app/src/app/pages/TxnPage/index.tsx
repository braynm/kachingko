...
import { Eye, EyeOff, Loader2, TableProperties, Search, ArrowDownUp, CalendarDays, RotateCcw, ImportIcon, UploadIcon, Upload } from 'lucide-react'
import {
  Table,
  TableBody,
  TableCell,
    ...
    <>
      <div className='container mx-auto w-full max-w-7xl w-7xl flex gap-5'>
        <Card className="min-w-[880px]">
          ...
          <CardFooter className='m-auto'>
            {hasNextPage && <Button
              ...
              className='transition transition-all shadow shadow-lg uppercase cursor-pointer bg-secondary text-secondary-foreground'
            >
        ...
        <div>
          ...
          {/* <CardMonthTotal title='PREVIOUS MONTH' startDate={'2024-08-01'} endDate={'2024-08-31'} /> */}
          {/* <CardMonthTotal title='CURRENT MONTH' startDate={'2024-09-01'} endDate={'2024-09-30'} /> */}
        </div>
      </div>
    </>
  );
